            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="" style="overflow:auto !important;">
                        ...
                        <table id="binary_table" class="table table-striped table-lightfont border mt-3" width="100%">
                            <thead>
                                <tr class="row_header">
                                    <th>Count</th>
                                    <th>Full Name</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#search_field').on('keyup',function() {
                ...
                //live search
                if(position_value == ''){
                    $("#binary_table_body .searchable").each(function(index) {
                        if (index !== 0) {
                            $row = $(this);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.each(response.data, function (i, value) {
                        ...
                        if(level == null){
                            $('#binary_table > tbody:last-child').append(
                                '<tr class="row_data text-capitalize searchable">'+
                                    '<td>'+cont_counter+'</td>'+
                                    '<td>'+value.full_name+'</td>'+
                                    '<td>'+value.user_name+'</td>'+
                                    '<td>'+value.package+'</td>'+
