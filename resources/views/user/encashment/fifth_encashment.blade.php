...
@section('title','Fifth Pair Encashment')
                        ...
                        <div class="card bg-info-gradient">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <h6 class="card-title">Total 5th Pairing Bonus</h6>
                                </div>
                                <div class="d-flex justify-content-between align-items-center">
                                    <h2 class="font-weight-bold"> {{ $total_earnings ?? 0 }}</h2>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card bg-success-gradient">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <h2 class="font-weight-bold">{{ $total_encashment ?? 0 }}</h2>
                                    <div class="avatar border-0">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card bg-warning-gradient">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <h2 class="font-weight-bold">{{ $total_balance ?? 0 }}</h2>
                                    <div class="avatar border-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="password_verification" placeholder="Password" type="password" required>
                                    </div>
                                </div>
                            </div>
                            <label for="formControlRange">Note:</label>
                            <br>
                            <label for="formControlRange">Tax: 0%</label>
                            <br>
                            <label for="formControlRange">Processing Fee: 0</label>
                            <br>
                    ...
                    <table id="encashment_tbl" width="100%" class="table table-striped table-lightfont">
                        ...
                        <tbody>
                            ...
                            <tr class="text-capitalize">
                                ...
                                <td>
                                    @if($data->status=='pending') <span class="text-warning">Pending for approval</span>
                                    @elseif($data->status=='approved') <span class="text-primary">Ready to claim</span>
                                    @elseif($data->status=='claimed') <span class="text-success">Claimed</span>
                                    @else <span class="text-danger">{{$data->status}}</span> @endif
                                </td>
                                <td>
                                    @if($data->status=='pending') Pending @else {{$data->updated_at}} @endif
                                </td>
                            </tr>
                            @endforeach
                            @endif
...
<script src="{{asset('js/user/fifth-pair-member-encashment.js?v=1.5')}}"></script>
@endsection
