                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            <ul class="list-inline-group text-right mb-0 pl-0">
                                ...
                                <li class="list-inline-item"><input type="checkbox" class="js-switch-performance" checked />
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="table-responsive dash-flag-icon">
                        <table class="table table-borderless mb-2">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row"><img src="{{ asset('teller_assets/images/browser/chrome.png') }}"
                                            class="img-fluid" alt="chrome"></th>
                                    <td>Google Chrome</td>
                                    <td>35%</td>
                                </tr>
                                <tr>
                                    <th scope="row"><img src="{{ asset('teller_assets/images/browser/safari.png') }}"
                                            class="img-fluid" alt="safari"></th>
                                    <td>Safari</td>
                                    <td>30%</td>
                                </tr>
                                <tr>
                                    <th scope="row"><img src="{{ asset('teller_assets/images/browser/windows.png') }}"
                                            class="img-fluid" alt="windows"></th>
                                    <td>Microsoft Edge</td>
                                    <td>20%</td>
                                </tr>
                                <tr>
                                    <th scope="row"><img src="{{ asset('teller_assets/images/browser/mozilla.png') }}"
                                            class="img-fluid" alt="mozilla"></th>
                                    <td>Mozilla Firefox</td>
                                    <td>10%</td>
                                </tr>
                                <tr>
                                    <th scope="row"><img src="{{ asset('teller_assets/images/browser/opera.png') }}"
                                            class="img-fluid" alt="opera"></th>
                                    <td>Opera</td>
                                    <td>5%</td>
                                </tr>
                            </tbody>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-borderless mb-2">
                            <tbody>
                                <tr>
                                    <td><img src="{{ asset('teller_assets/images/users/girl.svg') }}" width="35"
                                            alt="girl"></td>
                                    <td>
                                ...
                                <tr>
                                    <td><img src="{{ asset('teller_assets/images/users/men.svg') }}" width="35"
                                            alt="men"></td>
                                    <td>
                                ...
                                <tr>
                                    <td><img src="{{ asset('teller_assets/images/users/boy.svg') }}" width="35"
                                            alt="boy"></td>
                                    <td>
                                ...
                                <tr>
                                    <td><img src="{{ asset('teller_assets/images/users/women.svg') }}" width="35"
                                            alt="women"></td>
                                    <td>
