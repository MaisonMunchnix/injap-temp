					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group" data-toggle="tooltip" data-placement="top" title="Description is not required">
								...
								<textarea class="form-control edit_req_fields" name="description" id="edit_description" placeholder="Description"></textarea>
							</div>
						</div>
					</div>
					<div class="row">
						...
						<table class="table table-bordered table-hover" style="width:100%;">
							<thead>
								<tr>
									...
									<td style="width:50%">
										<button type="button" id="edit_add-sub-package" class="btn btn-primary btn-sm"><i class='feather icon-plus'></i> + Sub Package</button>
									</td>
								</tr>
							</thead>
							<tbody id="edit-sub-package-group"></tbody>
						</table>
					</div>-->
					<div class="row">
						<table class="table table-bordered table-hover" style="width:100%;">
