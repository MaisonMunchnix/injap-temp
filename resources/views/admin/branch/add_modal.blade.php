		...
		<div class="modal-content">
			<form action="" method="post" id="add_announcement" enctype="multipart/form-data">
				<div class="modal-header faded smaller">
					<div class="modal-title"><span>Add Announcement</span></div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<div class="date-input">
									<input class="datepicker form-control" id="date_end" name="date_end" placeholder="Post Date End" type="text" autocomplete="off">
								</div>
							</div>
						</div>
						<div class="col-sm-6">
