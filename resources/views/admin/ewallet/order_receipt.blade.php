                ...
                <div class="card-body p-50">
                    <div class="invoice">
                        <div class="d-md-flex justify-content-between align-items-center">
                            ...
                            <h3 class="text-xs-left m-b-0">Invoice {{ sprintf('%06d', $sale->id) }}</h3>
                        </div>
                        <hr class="m-t-b-50">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-right">{{ $sale->getInvoiceName() }} @if ($sale->getUsername())
                                        - {{ $sale->getUsername() }}
                                    @endif,<br> {{ $sale->getInvoiceAddress() }}.
                                </p>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($sale->products as $order)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                P{{ number_format($order->pivot->price * $order->pivot->quantity, 2) }}
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
