                ...
                <div class="modal-content text-center">
                    ...
                    <div class="onboarding-slider-w">
                        <div class="onboarding-slide">
                            <div class="onboarding-media"><img alt="" src="css/img/bigicon2.png" width="200px">
                            </div>
...
-------------------->
            <div class="menu-mobile menu-activated-on-click color-scheme-dark">
                <div class="mm-logo-buttons-w">
                    <a class="mm-logo" href="{{ route('landing.home') }}"><img src="css/img/logo.png"><span>Company
                            Name</span></a>
                    ...
                    <div class="logged-user-i">
                        ...
                        <div class="logged-user-menu color-style-bright">
                            ...
                            <ul>
                                ...
                                <li><a href="#"><i class="os-icon os-icon-signs-11"></i><span>Logout</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="sub-menu-w">
                            ...
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="users_profile_small.html">Logout</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
