	...
	<div class="table-responsive border-bottom" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
		<table class="table mb-0 thead-border-top-0" id="product_categories_table" style="width:100% !important">
			...
			<tbody class="list">
				...
				<tr>
					<td>{{ $package_product->type }}</td>
					<td>{{ $package_product->referral_amount }}</td>
					<td>{{ $package_product->pv_points }}</td>
					<td>{{ $package_product->account_discount * 100 }}%</td>
					<td>{{ $package_product->created_at }}</td>
					<td>
						<div class="btn-group" role="group" aria-label="Action Buttons">
							<button type="button" class="btn btn-warning btn-sm editRecord" data-toggle="modal" data-id="{{$package_product->id}}"><i class='feather icon-edit-2'></i></button>
							<button type="button" class="btn btn-danger btn-sm deleteData" data-toggle="modal" data-id="{{$package_product->id}}"><i class='feather icon-trash'></i></button>
						</div>
			...
			<form method="POST" action="{{ route('packages-save') }}">
				...
				<div class="modal-body">
					<div class="form-group" data-toggle="tooltip" data-placement="top" title="Type is required">
						...
						<input class="form-control" placeholder="Type" id="type" name="type" type="text" required>
					</div>
					...
					<div class="form-group" data-toggle="tooltip" data-placement="top" title="Referral Amount is required">
						...
						<input class="form-control" placeholder="Referral Amount" id="referral_amount" name="referral_amount" type="text" required>
					</div>
					...
					<div class="form-group" data-toggle="tooltip" data-placement="top" title="PV Points is required">
						...
						<input class="form-control" placeholder="PV Points" id="pv_points" name="pv_points" type="text" required>
					</div>
					...
					<div class="form-group" data-toggle="tooltip" data-placement="top" title="Account Discount is required">
						...
						<input class="form-control allownumericwithdecimal" placeholder="Account Discount" id="account_discount" name="account_discount" type="text" required>
					</div>
				</div> <!-- // END .modal-body -->
