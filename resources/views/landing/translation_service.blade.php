...
@section('title', 'INJAP - Innovation Japan | Translation Service')
            ...
            <div class="row">
                <div class="co-md-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime">Translation Service</h1>
                    ...
                    <div class="service-single-content">
                        <div class="service-single-img wow fadeInUp" data-wow-delay="0.25s">
                            <figure class="image-anime">
                                <img src="{{ asset('new_landing/images/translation.jpg')}}" alt="">
                            </figure>
                        </div>
                        ...
                        <div class="service-single-body">
                            ...
                            <p>This Association offer it’s translation service such as, Loan translation service, documents translation, online and face to face translation. </p>

                        
                            
                            <p>Innovation Japan provides professional translation services to help members communicate clearly and confidently in any situation.</p>

                            <p>Our goal is to bridge language barriers and ensure every member receives accurate, reliable, and confidential translation assistance whenever needed.</p>
                            ...
                            <div class="faq-accordion" id="accordion">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                        ...
                                        <div class="accordion-body">
                                            <p>We provide loan, document, online, and in-person translation services to meet the different needs of our members.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- FAQ Item end -->
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                        data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            <p>Members can request translation support by contacting the association office for assistance.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- FAQ Item end -->
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingThree">
                                       ...
                                       Are the translation services free for members?
                                        </button>
                                    </h2>
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                        data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            <p>Basic translation assistance is included as part of your membership benefits. However, specialized or bulk translations may have minimal service fees.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- FAQ Item end -->
