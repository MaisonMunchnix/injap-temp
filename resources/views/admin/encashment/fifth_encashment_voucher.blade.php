                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <p class="text-left">
                                ...
                                $encash_add_days=date('Y-m-d', strtotime($encash_date. ' - 7 days'));

                                $encash_month = date('F',strtotime($encash_date. ' - 1 days'));
                                $encash_day=date('d',strtotime($encash_date. ' - 1 days'));
                                ...
                                $cut_off= date('F d, Y', strtotime($encash_add_days)) ." to " . date('F d, Y', strtotime($encash_date. ' - 1 days'));
                                }
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <table style="width:100%">
                                ...
                                @if($tax > 0)
                                <tr>
                                    <td class="text-left">Witholding Tax {{$tax_percent}}%</td>
