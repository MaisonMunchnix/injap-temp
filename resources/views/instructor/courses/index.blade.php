                            ...
                            <table id="courses-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                <a href="#" class="btn btn-outline-light btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i data-feather="more-horizontal"></i>
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="{{ route('instructor.courses.edit', $course->id) }}" class="dropdown-item">Edit</a>
