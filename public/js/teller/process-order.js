...
$('.release-order').on('click', function(e){
    e.preventDefault();
    let url = $(this).attr('href');
    let shipping = $(this).attr('data-shipping');
    let text = shipping === '1' ? 'REMINDER: this transaction requires shipping! \n\n Customer has already paid and the products are ready for release?' :
        'Customer has already paid and the products are ready for release?';
    swal({
        title: "Confirm!",
        text: text,
