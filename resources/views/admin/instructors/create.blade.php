                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.instructors.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="username" class="form-label">Full Name <span style="color: red;">*</span></label>
                            <input type="text" class="form-control @error('username') is-invalid @enderror" id="username"
                                name="username" value="{{ old('username') }}" placeholder="Enter full name" required>
                            @error('username')
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('admin.instructors.index') }}" class="btn btn-danger text-white">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
