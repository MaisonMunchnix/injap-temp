				...
				<div class="table-responsive border-bottom">
					<table class="table mb-0 thead-border-top-0">
						...
						<tbody>
							...
							<tr class="item">
								<th class="title">{{ $package->type }}</th>
								<td><input type="number" id="{{ $package->type }}_qty" name="{{ $package->type }}_qty" class="qnty amount form-control" autocomplete="off"></td>
								<td><input type="number" id="{{ $package->type }}_price" name="{{ $package->type }}_price" class="price form-control" value="{{ $package->pv_points }}" readonly></td>
								<td><input type="number" id="{{ $package->type }}_total_price" name="{{ $package->type }}_total_price" class="total form-control" readonly="readonly"></td>
								<td><input type="number" id="{{ $package->type }}_discount" name="{{ $package->type }}_discount" class="discount form-control" readonly></td>
								<td><input type="number" id="{{ $package->type }}_discounted_total" name="{{ $package->type }}_discounted_total" class="discounted_total form-control" readonly="readonly"></td>
							</tr>
							@endforeach
						</tbody>
						<tfoot>
		...
		if (!username) {
			...
			$.ajax({
				...
				data: {
					username: username,
					@foreach($packages as $package)
					{{ $package->type }}_qty: $("#{{ $package->type }}_qty").val(),
					@endforeach
				},
