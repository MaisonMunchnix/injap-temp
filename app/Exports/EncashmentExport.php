...
class EncashmentExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    ...
    public function collection()
    {
        ...
        return DB::table('encashments_view')
            ->select('encash_created','username','member_lname','member_fname','amt_req','amt_appr','tax','process_fee',DB::raw('amt_appr - tax - process_fee AS net_pay'))
