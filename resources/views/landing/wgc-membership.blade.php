                    ...
                    <div class="project-box">
                        ...
                        <div class="project-box__item">
                            ...
                            <div class="media-body"><span class="project-box__label">Package Inclusions:</span>
                                <h4 class="project-box__info">Accidental Death and Disablement worth 75,000 PHP</h4>
                                <br>
                                <h4 class="project-box__info">Accident Medical Reimbursement worth 7,500 PHP</h4>
                                <br>
                                <h4 class="project-box__info">Accident Burial Benefit worth 7,500 PHP</h4>
                                <br>
                                <h4 class="project-box__info">Unprovoked Murder and Assault worth 75,000 PHP</h4>
                                <br>
                                <h4 class="project-box__info">Daily Hospital Income (Due to Accident & Sickness 15 Days per Confinement) worth 150 PHP / Day</h4>
                                <br>
                                <h4 class="project-box__info">Common Carrier worth 50,000 PHP</h4>
                            </div>
                        </div>
                        <div class="project-box__item">
