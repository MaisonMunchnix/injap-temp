            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link" title="User menu" data-sidebar-target="#user-menu">
                        <span class="mr-2 d-sm-inline d-none">
                            @if (!empty($global_user_data->username))
                                {{ $global_user_data->username }}
                            @endif
                        </span>
                        <figure class="avatar avatar-sm">
                            <img @if (!empty($global_user_data->profile_picture)) src="{{ asset($global_user_data->profile_picture) }}" @else src="{{ asset('images/users/default_image.png') }}" @endif
