    ...
    $('#claim_modal').on('shown.bs.modal', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var data_tax = parseInt(data_amount_appr) * 0.10;

                var total_claim = parseInt(data_amount_appr) - parseInt(data_tax) - process_fee;
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.encashment_data.status == 'pending') {
                    ...
                    var data_tax = parseInt(data_amount_req) * 0.10;
                    var total_claim = parseInt(data_amount_req) - parseInt(data_tax) - process_fee;
                ...
                $('#view-pfee').text(process_fee + 'PHP');
