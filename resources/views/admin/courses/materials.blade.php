                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="admin-materials-table" class="table table-striped table-bordered text-center">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Instructor</th>
                                    ...
                                    <tbody>
                                        @foreach($materials as $material)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-outline-primary btn-sm"
                                                        data-toggle="modal" data-target="#reviewModal{{ $material->id }}">
                                                        Review
                                                    </button>
                                                </td>
                                            </tr>
                                            ...
                                            <!-- Review Modal -->
                                            <div class="modal fade text-left" id="reviewModal{{ $material->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.courses.material-status', $material->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <div class="form-group row">
                                                                    <label class="col-sm-4 col-form-label">Current
                                                                        Status</label>
                                                                    <div class="col-sm-8">
                                                                        <input type="text" class="form-control"
                                                                            value="{{ ucfirst($material->status) }}" disabled>
                                                                    </div>
                                                                </div>

                                                                <div class="form-group row">
                                                                    <label for="status" class="col-sm-4 col-form-label">Update
                                                                        Status</label>
                                                                    <div class="col-sm-8">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="admin_note"
                                                                        class="col-sm-4 col-form-label">Admin
                                                                        Reason/Note</label>
                                                                    <div class="col-sm-8">
                                                                        <textarea class="form-control" name="admin_note"
                                                                            id="admin_note" rows="3"
                                                                            placeholder="Optional for approval, required if rejected (though not enforced by code).">{{ $material->admin_note }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
...
@section('scripts')
    <script>
        $(document).ready(function () {
            var table = $('#admin-materials-table').DataTable({
                order: [[7, 'desc']],
                columnDefs: [
                    { orderable: false, targets: [4, 8] } // File Link & Action not sortable
                ]
            });

            // Filter by Course (column index 2)
